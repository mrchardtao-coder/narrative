...
输出 JSON：
{"scene":"场景一句话","acts":[{"npc":"角色名","direction":"2-3句表演指导：此刻状态、情绪、反应方向。不写具体台词。"}]}
规则：只安排被主角直接影响的角色，最多3幕。输出纯JSON。`;
  },
...
规则：
1. 2-4句话。只描述光线、声音、物体、位置变化。
2. 禁止描述任何NPC和主角的对话、内心、情绪、行为。主角由玩家控制，NPC由独立引擎控制。你只描述环境。
3. 你拿到"已知NPC已作出反应"后，只补充环境变化，不重复NPC发言。
4. 第二人称"你"。`;
  },
